<template>
  <div>
    ...
    >
      ...
      >
        <div>
          <span style="color:#909399;">E-mail：{{ email }} </span>
        </div>
      </el-card>
      <el-card
        :body-style="{ padding: '10px' }"
        ...
        <table border="0">
          <tr>
            <td align="center" style="max-width: 160px;min-width: 160px">
              ...
              <span style="color:#909399;font-size: x-small">
                (鼠标滚轮缩放图片)</span
              >
            </td>
            <td align="center" style="max-width: 100px;min-width: 100px">
              <el-button
                ...
                @click="clickFile()"
                style="margin:10px 0"
                >上传<i class="el-icon-picture-outline el-icon--right"></i
              ></el-button>
              <br /><br />
              <el-button
                round
                ...
                @click="getCropData()"
                style="margin:10px 0"
                >使用<i class="el-icon-check el-icon--right"></i
              ></el-button>
            </td>
