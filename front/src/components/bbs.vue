      ...
      <el-row :gutter="20">
        <el-col :span="1">
          <el-popover
            ...
            <el-button slot="reference" @click="visible = !visible">新主题 <i class="el-icon-edit-outline"></i></el-button>
          </el-popover>
        </el-col>
