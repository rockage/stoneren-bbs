  ...
  <div class="div-center" @mousedown="move" ref="divCenter" id="post_box">
    ...
    <div v-show="postMode==='new'">
      <div style="align-items: center;display: flex;justify-content: space-between;">
        ...
        <el-select style="width: 100%;" v-model="currentForumId" placeholder="请选择">
          <el-option
  ...
  export default {
    ...
    methods: {
      ...
      saveHtml: function () {
        ...
        param.append("fid", vm.currentForumId)
            ...
            if (response.data === "login-error") {
              ...
              switch (this.postMode) {
                case "edit":
                  break;
                case "new":
                  vm.setContextData("newThreadForumId", vm.currentForumId)
    ...
    mounted() {
      ...
      this.currentForumId = this.fid
      this.forums = this.root.$store.getters.fsname
